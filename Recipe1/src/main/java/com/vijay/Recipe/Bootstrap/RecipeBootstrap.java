...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
	...
	private List<Recipe> getRecipes() {
		...
		// ---->> IF WE DO NOT ADD DATA THROUGH DATA.SQL(SOURCES) THEN WE CAN DO IT
		// MANUALY AS WE DONE IT BLOW------>>
		...
		guacRecipe.setSource("Delhi");
		guacRecipe.setUrl("https://www.simplyrecipes.com/recipes/perfect_guacamole/");

		guacRecipe.setDifficulty(Difficulty.EASY);
		guacRecipe.setDirections(
				"1 Cut the avocado, remove flesh: Cut the avocados in half. Remove the pit. Score the inside of the avocado with "
		...
		guacRecipe.addIngredient(
				new Ingredient("minced red onion or thinly green onion", new BigDecimal(2), tableSpoonUom));
		guacRecipe.addIngredient(
		...
		guacRecipe.addIngredient(
				new Ingredient("ripe tomato, seed and pulp removed, chopped", new BigDecimal(5), eachUom));
